      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="block">
              <h1 class="animated fadeInUp">Koffa Managment<br> KAFIL EL-YATIME</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 col-sm-12">
            <div class="block">
              <img src="http://www.uft.org/files/photo/kids-helping-kids-09.jpg" alt="Img">
            </div>
          </div><!-- .col-md-5 close -->
        </div>
      </div>
          ...
          <div class="col-md-6">
            <div class="testimonial-carousel">
              <div id="testimonial-slider" class="owl-carousel">
                <div>
                    <img src="{{ asset('intro/img/cotation.png')}}" alt="IMG">
                    ...
                    <div class="user">
                      <img src="{{ asset('intro/img/item-img1.jpg')}}" alt="Pepole">
